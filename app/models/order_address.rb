...
#creditのバリデーションも書く
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, block_number: block_number, building_name: building_name, phone: phone, order_id: order.id)
  end
